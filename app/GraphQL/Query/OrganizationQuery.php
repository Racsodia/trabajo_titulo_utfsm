...
class OrganizationQuery extends Query
{
    protected $attributes = [
        ...
        'description' => 'Retorna la lista de organizaciones que cumplan con el criterio especificado'
    ];

    public function type()
    {
        return GraphQL::paginate('organization');
    }
    ...
    public function args()
    {
        return [
            'limit' => [
                'type' => Type::int(),
                'description' => 'Límite de organizaciones por página',
            ],
            'page' => [
                'type' => Type::int(),
    ...
    public function resolve($root, $args, SelectFields $fields, ResolveInfo $info)
    {
        ...
        $temp = Organization::with(array_keys($fields->getRelations()))->where($where)->get();
