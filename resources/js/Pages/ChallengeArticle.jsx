                    ...
                    <MDBContainer className="p-0">
                        <MDBRow>
                            <MDBCol size="sm-7" className="mt-3">
                                {localStorage.getItem("tk") != null &&<ModalCreateChallenge newChallenge={this.setNewChallenge} filter = 'articles' rendermode={1}/>}
                                <hr className="hr-bar w-100"></hr>
                                <h5 className="text-center"><b> Desafíos recientes</b></h5>
                                <hr className="hr-bar w-100"></hr>
                                <ChallengesAlbum rendermode={1} filter = 'articles' id = {this.props.match.params.id}/>
                            </MDBCol>
